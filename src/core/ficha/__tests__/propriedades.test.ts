...
describe('o motor novo não é autoritativo', () => {
  const PONTE_PERMITIDA = [
    ...
    'components/creation/CriadorDeFicha.tsx',
    'components/creation/PreviaDaFicha.tsx',
    'components/creation/EtapaRevisao.tsx',
    'logic/rascunhoDeCriacao.ts',
    'logic/__tests__/rascunhoDeCriacao.test.ts',
