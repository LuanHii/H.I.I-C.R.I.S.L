        ...
        <div className="absolute inset-0 overflow-y-auto custom-scrollbar">
            ...
            {activeTab === 'agentes' && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-7xl mx-auto p-6">
                    <h2 className="text-2xl font-serif text-white mb-6 border-b border-ordem-border pb-2">Agentes da Ordem</h2>
                    <AgentList />
                </div>
            )}
            ...
            {activeTab === 'ameacas' && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-7xl mx-auto h-full flex flex-col p-6">
                    <h2 className="text-2xl font-serif text-white mb-6 border-b border-ordem-border pb-2">Bestiário Paranormal</h2>
