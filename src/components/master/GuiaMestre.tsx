...
const CAT_GRADIENTS: Record<string, string> = {
    'criacao': 'from-emerald-500/15 to-emerald-500/5',
    'testes': 'from-blue-500/15 to-blue-500/5',
    'combate': 'from-red-500/15 to-red-500/5',
    'ataques': 'from-orange-500/15 to-orange-500/5',
    'manobras': 'from-yellow-500/15 to-yellow-500/5',
    'condicoes': 'from-purple-500/15 to-purple-500/5',
    'sanidade': 'from-cyan-500/15 to-cyan-500/5',
    'rituais': 'from-pink-500/15 to-pink-500/5',
    'equipamento': 'from-green-500/15 to-green-500/5',
    'investigacao': 'from-amber-500/15 to-amber-500/5',
};

const CAT_GLOW: Record<string, string> = {
    'criacao': 'hover:shadow-[0_0_20px_rgba(16,185,129,0.06)]',
    'testes': 'hover:shadow-[0_0_20px_rgba(59,130,246,0.06)]',
    'combate': 'hover:shadow-[0_0_20px_rgba(239,68,68,0.06)]',
    'ataques': 'hover:shadow-[0_0_20px_rgba(251,146,60,0.06)]',
    'manobras': 'hover:shadow-[0_0_20px_rgba(234,179,8,0.06)]',
    'condicoes': 'hover:shadow-[0_0_20px_rgba(168,85,247,0.06)]',
    'sanidade': 'hover:shadow-[0_0_20px_rgba(34,211,238,0.06)]',
    'rituais': 'hover:shadow-[0_0_20px_rgba(236,72,153,0.06)]',
    'equipamento': 'hover:shadow-[0_0_20px_rgba(34,197,94,0.06)]',
    'investigacao': 'hover:shadow-[0_0_20px_rgba(245,158,11,0.06)]',
};

const CAT_ACTIVE_BORDER: Record<string, string> = {
    'criacao': 'border-emerald-500/40',
    'testes': 'border-blue-500/40',
    'combate': 'border-red-500/40',
    'ataques': 'border-orange-500/40',
    'manobras': 'border-yellow-500/40',
    'condicoes': 'border-purple-500/40',
    'sanidade': 'border-cyan-500/40',
    'rituais': 'border-pink-500/40',
    'equipamento': 'border-green-500/40',
    'investigacao': 'border-amber-500/40',
};
