...
export default function FichasPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-ordem-white flex flex-col">
      ...
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-3 bg-zinc-950">
      <section className="border-r border-zinc-800 p-6 space-y-4 overflow-hidden">
        <div className="flex items-end justify-between gap-4">
          <div className="min-w-0">
            <div className="text-xs font-mono tracking-[0.35em] text-zinc-500 uppercase">Protocolo</div>
            <h1 className="text-2xl font-serif text-white truncate">C.R.I.S — Fichas</h1>
      ...
      <section className="lg:col-span-2 p-6 bg-zinc-950">
        {fichaAtual ? (
