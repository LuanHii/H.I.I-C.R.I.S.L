...
export const ReferenciaDeRegras: React.FC<{ className?: string }> = ({ className }) => (
  <div className={cn(CARTAO, 'space-y-4', className)}>
    ...
    <div className="space-y-3">
      ...
      <Regra titulo="Recapitular e Compartilhar">
